...
>(({ className, hoverable = false, squircle = false, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "paper-note relative text-card-foreground transition-all duration-200",
      !squircle && "rounded-[1.25rem]",
      squircle && "squircle-filter rounded-[2rem]",
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-lg font-semibold leading-none tracking-[0.08em] uppercase font-[family-name:var(--font-heading)]",
      className
    )}
    {...props}
  />
