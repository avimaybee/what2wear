...
export const Header = () => {
  ...
  return (
    <>
      {/* Desktop Header */}
      <header className="sticky top-0 z-50 w-full bg-background/90 backdrop-blur-sm border-0" role="banner">
        <div className="container flex h-14 max-w-screen-2xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4">
            ...
            >
              <span className="text-lg md:text-xl font-semibold font-[family-name:var(--font-heading)] text-foreground">
                SetMyFit
              </span>
            </Link>
          </div>
