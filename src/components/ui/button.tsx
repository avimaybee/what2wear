...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-4 focus-visible:ring-ring/30 active:scale-[0.98] transform",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-surface-1/50 hover:bg-surface-2 hover:border-border/80 backdrop-blur-sm",
        secondary:
